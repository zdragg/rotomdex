...
pub enum Version {
    ...
    #[serde(rename = "firered")]
    FireRed,
    #[strum(serialize = "leafgreen")]
    #[serde(rename = "leafgreen")]
    LeafGreen,
    Diamond,
    Pearl,
    Platinum,
    #[strum(serialize = "heartgold")]
    #[serde(rename = "heartgold")]
    HeartGold,
    #[strum(serialize = "soulsilver")]
    #[serde(rename = "soulsilver")]
    SoulSilver,
    Black,
    White,
...
impl Version {
    ...
    pub(crate) const fn color(&self) -> [u8; 3] {
        match self {
            Self::Red => [218, 57, 20],
            Self::Blue => [46, 80, 216],
            Self::Yellow => [255, 215, 51],
            Self::Gold => [218, 165, 32],
            Self::Silver => [192, 192, 192],
            Self::Crystal => [79, 217, 255],
            Self::Ruby => [205, 34, 54],
            Self::Sapphire => [61, 81, 167],
            Self::Emerald => [0, 150, 82],
            Self::FireRed => [241, 92, 1],
            Self::LeafGreen => [159, 220, 0],
            Self::Diamond => [144, 190, 237],
            Self::Pearl => [221, 124, 177],
            Self::Platinum => [160, 160, 141],
            Self::HeartGold => [232, 181, 2],
            Self::SoulSilver => [170, 185, 207],
            Self::Black => [68, 68, 68],
            Self::White => [225, 225, 225],
            Self::Black2 => [48, 62, 81],
            Self::White2 => [235, 197, 195],
            Self::X => [2, 93, 166],
            Self::Y => [234, 26, 62],
            Self::OmegaRuby => [171, 40, 19],
            Self::AlphaSapphire => [38, 100, 156],
            Self::Sun => [241, 145, 43],
            Self::Moon => [85, 153, 202],
            Self::UltraSun => [233, 91, 43],
            Self::UltraMoon => [34, 109, 181],
            Self::LetsGoPikachu => [245, 218, 38],
            Self::LetsGoEevee => [212, 146, 75],
            Self::Sword => [0, 161, 233],
            Self::Shield => [191, 0, 79],
            Self::BrilliantDiamond => [68, 186, 229],
            Self::ShiningPearl => [218, 125, 153],
            Self::LegendsArceus => [54, 89, 123],
            Self::Scarlet => [243, 65, 52],
            Self::Violet => [131, 52, 183],
            Self::LegendsZa => [49, 202, 86],
        }
    }
...
#[derive(
    Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, EnumString, EnumCount, VariantArray,
)]
#[strum(serialize_all = "kebab-case")]
...
impl VersionGroup {
    pub(crate) fn versions(&self) -> Vec<Version> {
        match self {
            ...
            Self::BrilliantDiamondShiningPearl => {
                vec![Version::BrilliantDiamond, Version::ShiningPearl]
            }
    ...
    pub(crate) fn generation(&self) -> Generation {
        match self {
            ...
            Self::SunMoon | Self::UltraSunUltraMoon | Self::LetsGoPikachuLetsGoEevee => {
                Generation::Gen7
            }
            Self::SwordShield | Self::BrilliantDiamondShiningPearl | Self::LegendsArceus => {
                Generation::Gen8
            }
